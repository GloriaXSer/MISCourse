...
/**
 * Servlet implementation class SectionDeleteAction
 */
@WebServlet("/SectionDeleteAction")
public class SectionDeleteAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SectionDeleteAction() {
        super();
